...
## Examples
---
This repository includes several Jupyter notebooks:
...
- `C10H16_cycle_analysis.ipynb`. Analysis of the size distribution of the `pi` and `sli` classes in the carbon skeleton of an adamantane ($\rm C_{10}H_{16}$) simulation at 4000K.
